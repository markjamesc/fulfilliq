...
publish <- function(measured, CONFIG) {
  ...
  print(figs$volume)
  openxlsx::insertPlot(wb, "charts", startRow = 1, startCol = 1, width = 9, height = 5)
  print(figs$distribution)
  openxlsx::insertPlot(wb, "charts", startRow = 28, startCol = 1, width = 9, height = 5)
  print(figs$precision)
  openxlsx::insertPlot(wb, "charts", startRow = 55, startCol = 1, width = 9, height = 5)
  print(figs$stability)
  openxlsx::insertPlot(wb, "charts", startRow = 82, startCol = 1, width = 9, height = 5)
